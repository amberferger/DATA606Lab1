...
**There is an overall increasing trend in the number of girls baptized between 1629 to 1710, with a dip between 1640 to 1660.**
...
mean(arbuthnot$boys / (arbuthnot$boys + arbuthnot$girls))

```

**The proportion of boys baptized per year remains fairly constant, hovering between 50% - 53%. On average, the proportion is around 51.7%, suggestiong more boys were baptized than girls.**
...
oldSet <- mean(arbuthnot$boys+arbuthnot$girls)
newSet <- mean(present$boys+present$girls)

# average number of baptisms arbuthnot dataset
oldSet

# average number of baptisms present dataset
newSet

# ratio of present dataset to old dataset
newSet/oldSet

```


**There are less years of data within this data set (the range is smaller), but there are far more boys and girls baptism records in the present set than in the old set.**
...
**The proportion of boys baptized in the US has been on a decline since the 1940s, showing a more even distribution of males to females. Although this data suggests that males are baptized more frequently than girls (51/49 ratio), if the trend continues, we would expect to see a distribution closer to 50/50 if we supplemented the data set with data from 2003 - 2019.**
